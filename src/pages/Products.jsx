                  ...
                  >
                    {allImages &&
                      allImages.map((el) => {
                        return (
                          <SwiperSlide
                            className={classes.gallery_image_wrapper}
                          >
                  ...
                  {lng !== "fa" ? (
                    ...
                    <>
                      ...
                      <p className={classes.current_price}>
                        {detailsData &&
                          formatNumber(
                            variationDetail?.product.sale_price * euro
                          )}
                        تومان (&nbsp;€&nbsp;
                        {detailsData && variationDetail.product.sale_price} )
                      </p>
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  const availableQuantity =
                                    +variationDetail?.product?.variation
                                      ?.quantity;
                    ...
                    <div className={classes.quantity_actions_wrapper}>
                      <span className={classes.weight_wrapper}>
                        ...
                        <p style={{ color: "#000000" }}>
                          :&nbsp;
                          {(
                            +variationDetail.product.variation.weight
                              .split(" ")
                              .at(0) * quantity
                          )?.toFixed(3)}
                          &nbsp;Ct
                ...
                <>
                  {token ? (
                    ...
                    <Button
                      ...
                      className={classes.addtocart}
                      onClick={() =>
                        handleAddToTemporaryCard(detailsData.product)
                      }
                    >
                      <Shop
                        style={{
                  ...
                  {lng !== "fa" ? (
                    <div className={classes.payment_ct}>
                      ...
                      <p className={classes.payment_value}>
                        {(
                          +variationDetail.product.sale_price * quantity
                        ).toFixed(2)}
                        {t("m_unit")}
                      </p>
                    </div>
