...
//        const opt = {
//          margin: [150, 10, 100, 10], // top, right, bottom, left (matches header/footer heights)
//          filename: `factor-${detailsData.order.order_number}.pdf`,
//          image: { type: "jpeg", quality: 0.98 },
//          html2canvas: {
//            scale: 2,
//            scrollY: 0, // Important to prevent scrolling issues
//            onclone: (clonedDoc) => {
//              // Ensure proper rendering of fixed elements
//              clonedDoc
//                .querySelectorAll(
//                  ".invoiceHeaderContainer, .invoiceFooterContainer"
//                )
//                .forEach((el) => {
...
//            before: ".invoiceHeaderContainer",
//            after: ".invoiceFooterContainer",
//          },
//        };
...
//  }, [detailsData]);
  ...
  return (
    <div ref={componentRef} className={classes.invoiceContainer}>
      <table className={classes.factorTable} dir={lng === "fa" ? "rtl" : "ltr"}>
        ...
        <tfoot className={classes.invoiceFooterContainer}>
          <tr>
