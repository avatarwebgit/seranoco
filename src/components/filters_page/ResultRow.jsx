 ...
 const renderActionButton = item => {
  ...
  return (
   <button
    ...
    onClick={() => handleSendShoppingCart(item, item.variation_id, quantity)}>
   ...
   <tbody>
    {data.map(item => (
     <tr
      ...
      <td className={classes.detail_text}>
       {lng === 'fa'
        ? item.attribute.find(attr => attr.attribute.name === 'Shape')?.value
           .name_fa
        : item.attribute.find(attr => attr.attribute.name === 'Shape')?.value
           .name}
      </td>
      ...
      <td className={classes.detail_text}>
       {
        item.attribute?.find(attr => attr.attribute.name === 'Details')?.value
         ?.name
       }
      </td>
