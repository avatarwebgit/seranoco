                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        const availableQuantity =
                          +variation?.product?.variation?.quantity;

                        if (
                          variation?.product?.variation?.is_not_available ===
                            0 &&
                          availableQuantity > 0
                        ) {
                      ...
                      style={{
                        borderColor: isMoreThanQuantity ? "red" : "black",
                      }}
                    />
                    {isMoreThanQuantity && (
            ...
            <div className={classes.final}>
              ...
              >
                {lng !== "fa"
                  ...
                  : formatNumber(
                      Math.round(quantity * productData.sale_price * euro)
                    )}
                &nbsp;
                <br />
                {t("m_unit")}
