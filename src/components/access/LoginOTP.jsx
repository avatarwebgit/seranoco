...
import { accesModalActions, drawerActions, signupActions, userActions } from '../../store/store';
...
const OTP = () => {
  ...
  const handleFinish = (e, otp = otpValue) => {
    const code = (otp || otpValue).join('');
    if (code) {
  ...
  const formattedTime = `${String(Math.floor(timeRemaining / 60000)).padStart(2, '0')}:${
  ...
  return (
    <div className={classes.content_wrapper}>
      <div className={classes.sheet}>
        ...
        <div className={classes.signup_link} style={{ direction: isRTL ? 'rtl' : 'ltr' }}>
